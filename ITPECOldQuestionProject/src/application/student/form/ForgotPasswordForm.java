...
public class ForgotPasswordForm {
    ...
    public Stage forgotPasswordForm() throws IOException {
        ...
        // Load FXML content
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/student/ForgetPassword.fxml"));
        ...
        forgotForm.initStyle(StageStyle.UNDECORATED); // Remove default window decorations// Auto-close when focus is lost
