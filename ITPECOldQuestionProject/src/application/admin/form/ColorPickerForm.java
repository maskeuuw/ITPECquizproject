...
import application.admin.controller.ColorPickerController;
...
public class ColorPickerForm {
    ...
    public static void showColorPicker(Consumer<Color> colorCallback, Consumer<String> avatarCallback) throws IOException {
    	 ...
    	 FXMLLoader loader = new FXMLLoader(ColorPickerController.class.getResource("/application/admin/ColorPicker.fxml"));
        ...
        Scene sc = new Scene(mainLayout, 480, 600);
        stage.setX(543);
        stage.setY(125);
