...
public class ColorPickerController {
    ...
    private void loadAvatars() {
        ...
        for (String avatarPath : imagePaths) {
            ...
            if (!file.exists()) {
                System.out.println(" Warning: Image not found - " + avatarPath);
     ...
     // Debug print for ensuring grid population
        System.out.println("Avatars loaded into the grid.");
    }
...
//        closeWindow();
    ...
    private void saveAvatarToDatabase(String avatarPath) throws IOException {
        try {
            ...
            String sql = "UPDATE admin SET photo=?, size=? WHERE admin_id=?";
            ...
            pst.setString(3, SignInController.id); // Use the logged-in user's ID
